...
Package version and release: `paper-release-2026-07-r6`
...
container can be built with `docker build -t fzyc-mol:paper-release-2026-07-r6 .`.
...
`paper-release-2026-07-r6`; its immutable commit is recorded in the GitHub release
...
> paper-release-2026-07-r6. GitHub. 2026.
