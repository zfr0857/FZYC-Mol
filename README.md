...
Package version and release: `paper-release-2026-08-r12.2`.
...
container can be built with `docker build -t fzyc-mol:paper-release-2026-08-r12.2 .`.
...
`paper-release-2026-08-r12.2`; its immutable commit is recorded in the GitHub release
...
> paper-release-2026-08-r12.2. GitHub. 2026.
...
Release `paper-release-2026-08-r12.2` is a format-only successor to the immutable
`paper-release-2026-08-r12.1` tag. It is a metadata and submission-format
...
The R12.2 refinement modestly reduces the vertical inter-panel spacing in
Figures 3 and 6 while retaining non-overlapping panel titles, colour strips and axes.
