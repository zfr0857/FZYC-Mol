...
Package version and release: `paper-release-2026-07-r3`
...
container can be built with `docker build -t fzyc-mol:paper-release-2026-07-r3 .`.
...
`paper-release-2026-07-r3`; its immutable commit is recorded in the GitHub release
...
> paper-release-2026-07-r3. GitHub. 2026.
