...
Package version and release: `paper-release-2026-07-r4`
...
container can be built with `docker build -t fzyc-mol:paper-release-2026-07-r4 .`.
...
`paper-release-2026-07-r4`; its immutable commit is recorded in the GitHub release
...
> paper-release-2026-07-r4. GitHub. 2026.
