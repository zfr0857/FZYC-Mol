...
Package version and release: `paper-release-2026-08-r12.1`.
...
container can be built with `docker build -t fzyc-mol:paper-release-2026-08-r12.1 .`.
...
`paper-release-2026-08-r12.1`; its immutable commit is recorded in the GitHub release
...
> paper-release-2026-08-r12.1. GitHub. 2026.
...
Release `paper-release-2026-08-r12.1` is a format-only successor to the immutable
`paper-release-2026-08-r12` tag. It is a metadata and submission-format
