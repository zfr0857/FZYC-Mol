...
Package version and release: `paper-release-2026-07-r5`
...
container can be built with `docker build -t fzyc-mol:paper-release-2026-07-r5 .`.
...
`paper-release-2026-07-r5`; its immutable commit is recorded in the GitHub release
...
> paper-release-2026-07-r5. GitHub. 2026.
